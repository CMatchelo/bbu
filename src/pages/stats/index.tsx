        ...
        <table className="w-full min-w-[820px] border-collapse">
          <thead>
            <tr className="bg-cardbglight">
              ...
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("points")}>PPG</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("assists")}>AST</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("blocks")}>BLK</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("rebounds")}>REB</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("fgm")}>FGM</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("fga")}>FGA</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("tpm")}>3PM</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("tpa")}>3PA</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("steals")}>STL</TableHead>
              <TableHead className="cursor-pointer" onClick={() => setOrderKey("turnovers")}>TO</TableHead>
              <TableHead>+-</TableHead>
            </tr>
          </thead>
          <tbody>
