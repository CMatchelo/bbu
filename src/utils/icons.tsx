export const Icons = {
  ...
  champions: (
    ...
    >
      ...
      <path d="M3 4H2a1 1 0 0 0-1 1v1a3 3 0 0 0 3 3M11 4h1a1 1 0 0 1 1 1v1a3 3 0 0 1-3 3M8 11v3M5 14h6" />
    </svg>
  ),
  news: (
    <svg
  ...
  facilities: (
    ...
    >
      ...
      <rect x="10" y="1" width="4" height="13" />
    </svg>
  ),
  university: (
    <svg
  ...
  logout: (
    <svg
      ...
      className="w-full h-full"
    >
      <path d="M6 2H3a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h3M10 11l4-3-4-3M6 8h8" />
    </svg>
  ),
  IconCourt: (
    <svg
  ...
  IconArrowDown: (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`size-3.5 text-text2 "rotate-180"}`}
    >
